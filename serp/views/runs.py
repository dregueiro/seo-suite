...
from serp.models import SerpRun, SerpResult
...
def serp_runs(request):
    ...
    return render(request, "serp/serp_runs.html", {"page_obj": page_obj})
...
def serp_run_detail(request, run_id: int):
    ...
    return render(request, "serp/serp_run_detail.html", {"run": run, "page_obj": page_obj})
