...
from core.forms import KeywordImportForm
from core.models import Keyword
from django.core.paginator import Paginator
from django.db.models import Q

from core.models import Project, Keyword, Country, Language
...
def keyword_import(request):
    ...
    return render(request, "core/keyword_import.html", {"form": form})
